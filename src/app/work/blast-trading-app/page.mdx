...
Cedar Labs worked quickly to in a matter of weeks to:
...
The Blast Trading App was able to launch successfully sooner than expected thanks to the quick work from Cedar Labs to elevate their codebase to professional and production-ready engineering standards. 
...
<Blockquote
  ...
  image={{ src: imageCeo }}
>
  Honestly, we were a bit desperate when we approached Cedar Labs.
